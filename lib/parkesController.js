...
class ParkesController {
	...
	async index(ctx, next) {
		...
		await hook(this, 'beforeIndex', ctx);
		...
		await hook(this, 'afterIndex', ctx, models.collection);
	...
	async create(ctx, next) {
		...
		await hook(this, 'afterCreate', ctx, model);
	...
	async update(ctx, next) {
		...
		await hook(this, 'afterUpdate', ctx, model);
	...
	async destroy(ctx, next) {
		...
		await hook(this, 'beforeDestroy', ctx, model);
		await this.rest.destroy(ctx, model);
		await hook(this, 'afterDestroy', ctx, model);
