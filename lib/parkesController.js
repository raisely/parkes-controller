...
class ParkesController {
	...
	async findOne(ctx, next) {
		const model = await this.rest.find(this);
	...
	async findAll(ctx, next) {
		...
		const models = await this.rest.findAll(ctx);
	...
	async create(ctx, next) {
		...
		const model = await this.rest.create(this);
	...
	async destroy(ctx, next) {
		...
		await this.rest.destroy(this, model);
